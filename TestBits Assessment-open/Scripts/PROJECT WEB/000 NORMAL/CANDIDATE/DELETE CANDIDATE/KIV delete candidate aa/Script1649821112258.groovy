...
WebUI.callTestCase(findTestCase('PROJECT WEB/000 NORMAL/CANDIDATE/ADD CANDIDATE group/Positive/add candidate'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/PROJECT WEB/candidate/Page_OrangeHRM/td_john di alba'))
