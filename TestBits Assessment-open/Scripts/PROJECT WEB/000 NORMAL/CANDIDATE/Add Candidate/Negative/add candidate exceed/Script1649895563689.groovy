...
WebUI.uploadFile(findTestObject('PROJECT WEB/require and add file/input_Resume_addCandidateresume'), 'C:\\Users\\syazw\\Documents\\GitHub\\resume big.pdf')
...
WebUI.click(findTestObject('PROJECT WEB/require and add file/div_Failed to Save File Size Exceeded       Close'))
