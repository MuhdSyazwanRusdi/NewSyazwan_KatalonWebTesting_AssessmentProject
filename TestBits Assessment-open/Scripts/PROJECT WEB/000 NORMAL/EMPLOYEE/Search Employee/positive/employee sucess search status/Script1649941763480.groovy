...
WebUI.selectOptionByValue(findTestObject('PROJECT WEB/employee/search/select_jobselect'), '3', true)

WebUI.click(findTestObject('Object Repository/PROJECT WEB/employee/search/input_Sub Unit__search'))

WebUI.click(findTestObject('PROJECT WEB/employee/search/td_Chief Executive Officer'))
