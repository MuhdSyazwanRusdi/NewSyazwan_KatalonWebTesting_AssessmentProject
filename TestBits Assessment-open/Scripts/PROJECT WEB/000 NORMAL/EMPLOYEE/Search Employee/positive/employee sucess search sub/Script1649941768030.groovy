...
WebUI.selectOptionByValue(findTestObject('PROJECT WEB/employee/search1/select_AllAdministrationEngineeringDevelopm_a385e1'), 
    '4', true)

WebUI.click(findTestObject('Object Repository/PROJECT WEB/employee/search/input_Sub Unit__search'))

WebUI.click(findTestObject('PROJECT WEB/employee/search1/td_Development'))
