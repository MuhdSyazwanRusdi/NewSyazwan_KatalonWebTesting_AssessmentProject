...
WebUI.setText(findTestObject('Object Repository/PROJECT WEB/employee/input__firstName'), 'ahmad')
...
WebUI.setText(findTestObject('Object Repository/PROJECT WEB/employee/input__user_password'), 'passwo')

WebUI.click(findTestObject('PROJECT WEB/employee/span_Very Weak'))

WebUI.click(findTestObject('PROJECT WEB/employee/span_Should have at least 8 characters'))
