...
WebUI.click(findTestObject('Object Repository/PROJECT WEB/employee/delete/div_Employee Information                   _e73847'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/employee/delete/input_Sub Unit__search'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/employee/delete/input_Supervisor_chkSelectRow'))
