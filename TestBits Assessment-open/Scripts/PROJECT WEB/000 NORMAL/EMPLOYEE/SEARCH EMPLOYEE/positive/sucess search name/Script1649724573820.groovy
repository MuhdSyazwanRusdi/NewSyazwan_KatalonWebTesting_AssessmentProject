...
WebUI.setText(findTestObject('PROJECT WEB/employee/search/input_Employee Name_empsearchemployee_nameempName'), 'Ali Mohd')

WebUI.click(findTestObject('Object Repository/PROJECT WEB/employee/search/input_Sub Unit__search'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/employee/search/td_Ali Mohd'))
